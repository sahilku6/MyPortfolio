        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Features escalating difficulty, immersive visual-only cues, and engaging multiplayer support—designed to sharpen memory and concentration through dynamic color sequence challenges
              </p>
            </div>
            <footer>
